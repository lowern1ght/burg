...
public class NpcModel<T extends Npc> extends HumanoidModel<T> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(OuatUtils.resource("npc"), "main_layer");
    ...
    private HumanoidModel.ArmPose getArmPose(T npc, InteractionHand pHand) {
        ...
        if (itemstack.isEmpty()) {
            ...
            HumanoidModel.ArmPose forgeArmPose = net.minecraftforge.client.extensions.common.IClientItemExtensions.of(itemstack).getArmPose(npc, pHand, itemstack);
