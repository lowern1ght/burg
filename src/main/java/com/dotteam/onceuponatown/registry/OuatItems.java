...
public class OuatItems {
    ...
    public static final RegistryObject<Item> CITIZEN_SPAWN_EGG = ITEMS.register("npc_spawn_egg", () ->
            new ForgeSpawnEggItem(OuatEntities.NPC, 0x96691f, 0x38b934/*51A03E*/, new Item.Properties()));
