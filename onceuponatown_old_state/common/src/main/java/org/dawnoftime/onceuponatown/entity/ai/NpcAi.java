...
import org.dawnoftime.onceuponatown.entity.ai.core.FindBed;
import org.dawnoftime.onceuponatown.entity.ai.core.NpcCalmDown;
import org.dawnoftime.onceuponatown.entity.ai.core.NpcPanic;
import org.dawnoftime.onceuponatown.entity.ai.work.WorkTask;
...
public class NpcAi {
    ...
    private static void setupWorkActivity(Brain<Npc> brain, Profession profession, float speedModifier) {
        WorkTask workBehavior = profession.getWorkAi().getWorkTask();
        brain.addActivity(Activity.WORK, ImmutableList.of(
            workBehavior.create().priority(0),
            //getMinimalLookBehavior(),
            Pair.of(99, UpdateActivityFromSchedule.create())
        ));
    }
