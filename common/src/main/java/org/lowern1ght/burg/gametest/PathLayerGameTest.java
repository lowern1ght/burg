...
import org.lowern1ght.burg.behavior.road.RoadGraph;
import org.lowern1ght.burg.behavior.road.RoadLayer;
...
public class PathLayerGameTest {
    ...
    private static final ResourceLocation EXPECTED_STREET =
        ResourceLocation.fromNamespaceAndPath("burg", "streets/street_step");
    private static final ResourceLocation EXPECTED_BRIDGE =
        ResourceLocation.fromNamespaceAndPath("burg", "streets/street_bridge_3");
    private static final ResourceLocation EXPECTED_CULVERT =
        ResourceLocation.fromNamespaceAndPath("burg", "streets/street_culvert");
    ...
    /**
     * A minimal {@link org.lowern1ght.burg.behavior.task.TaskContext}
     ...
     */
    private static org.lowern1ght.burg.behavior.task.TaskContext stubContext(
            GameTestHelper helper) {
        ServerLevel level = helper.getLevel();
        return new org.lowern1ght.burg.behavior.task.TaskContext(
            level, level.getGameTime(), new org.lowern1ght.burg.behavior.intent.NpcSupplier() {
                @Override
                public List<org.lowern1ght.burg.entity.Npc> freeCitizens(Town town) {
                    return List.of();
                }
                @Override
                public Optional<org.lowern1ght.burg.entity.Npc> findByUuid(
                        java.util.UUID id) {
                    return Optional.empty();
                }
            },
            null,
            new org.lowern1ght.burg.behavior.morale.MoraleState());
    }
}
