...
public class RenameSmokeGameTest {
    ...
    public static void rename_roadTaskExists_pathTaskGone(GameTestHelper helper) {
        ...
        Class<?> roadTaskClass;
        try {
            roadTaskClass = Class.forName("org.lowern1ght.burg.behavior.task.RoadTask");
        ...
        try {
            Class.forName("org.lowern1ght.burg.behavior.task.PathTask");
        ...
        try {
            Class.forName("org.lowern1ght.burg.behavior.road.RoadBuilder");
            Class.forName("org.lowern1ght.burg.behavior.road.RoadPlanner");
            Class.forName("org.lowern1ght.burg.behavior.road.RoadLayer");
            Class.forName("org.lowern1ght.burg.behavior.road.RoadLayerFromStructures");
            Class.forName("org.lowern1ght.burg.behavior.road.RoadSegment");
            Class.forName("org.lowern1ght.burg.behavior.road.RoadType");
            Class.forName("org.lowern1ght.burg.behavior.road.RoadGraph");
            Class.forName("org.lowern1ght.burg.behavior.road.TerrainCost");
        } catch (ClassNotFoundException e) {
        ...
        try {
            Class.forName("org.lowern1ght.burg.behavior.path.RoadBuilder");
