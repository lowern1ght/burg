...
import org.lowern1ght.burg.town.MapCategory;
...
public class TownMapWidget extends AbstractWidget {
    ...
    private MapElement createRoadMapElement(CompoundTag tag, BlockPos nwCorner) {
        ...
        Component name = Component.translatable("burg.building." + buildType);
    ...
    private MapElement createUnderConstructionMapElement(CompoundTag tag, BlockPos nwCorner) {
        ...
        List<Component> desc = List.of(
            Component.translatable("burg.building." + buildType),
            Component.translatable("burg.tooltip.under_construction")
    ...
    private MapElement createBuildingMapElement(CompoundTag tag, BlockPos nwCorner) {
        ...
        MutableComponent name = Component.translatable("burg.building." + buildType)
        ...
        if (isUpgrading) {
            desc.add(Component.translatable("burg.tooltip.under_upgrade")
                .withStyle(ChatFormatting.YELLOW));
        }
        desc.add(Component.translatable("burg.tooltip.left_click_details")
            .withStyle(ChatFormatting.DARK_GRAY));
        desc.add(Component.translatable("burg.tooltip.right_click_upgrade")
            .withStyle(ChatFormatting.DARK_GRAY));
