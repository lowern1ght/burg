...
public enum NpcCulture {
    DESERT, JUNGLE, PLAINS, SAVANNA, SNOW, SWAMP, TAIGA;

    private static final Map<ResourceKey<Biome>, NpcCulture> BY_BIOME = Util.make(Maps.newHashMap(), (p) -> {
    ...
    public static NpcCulture byId(byte id) {
        for(NpcCulture culture : NpcCulture.values()) {
            if (id == culture.getId()) {
                return culture;
            }
        }
    ...
    public static NpcCulture byBiome(Holder<Biome> holder) {
