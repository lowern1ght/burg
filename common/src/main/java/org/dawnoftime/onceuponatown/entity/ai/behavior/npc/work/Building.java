...
import org.dawnoftime.onceuponatown.entity.ai.behavior.SetMemory;
import org.dawnoftime.onceuponatown.entity.ai.behavior.Task;
import org.dawnoftime.onceuponatown.entity.ai.behavior.Tasks;
import org.dawnoftime.onceuponatown.entity.ai.behavior.GoToPosition;
...
public class Building {
    ...
    public static Task<Npc> create(float speedModifier) {
        ...
        var executeStepOrGetCloser = tasks.firstValid("Execute step or get closer")
            .option(0, new GoToPosition<>("Get closer", npc -> npc.getAssignedProject().getNextStepPos(), 5, speedModifier))
