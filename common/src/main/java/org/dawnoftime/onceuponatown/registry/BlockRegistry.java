...
public abstract class BlockRegistry {
    ...
    public final Supplier<CultureCreatorBlock> CULTURE_CREATOR_BLOCK = registerWithItem("culture_creator", () -> new CultureCreatorBlock(BlockBehaviour.Properties.of().instabreak().noCollission()), (block -> new CultureCreatorItem(block, new Item.Properties())));
