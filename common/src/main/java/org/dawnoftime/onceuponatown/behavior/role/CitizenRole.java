package org.dawnoftime.onceuponatown.behavior.role;
 ...
 * org.dawnoftime.onceuponatown.entity.Npc.Role} (BUILDER/SETTLER). That field describes the
 * NPC's body, persisted with the entity; this one describes the citizen's work assignment in the
 * behaviour engine, recomputed every {@link RoleAssigner#update(org.dawnoftime.onceuponatown.town.Town,
