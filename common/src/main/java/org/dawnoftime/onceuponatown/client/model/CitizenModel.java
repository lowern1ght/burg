...
public class CitizenModel<T extends Citizen> extends HumanoidModel<T> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(OuatUtils.createOuatResource("citizen"), "main_layer");
    ...
    public void setupAnim(@NotNull T citizen, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
