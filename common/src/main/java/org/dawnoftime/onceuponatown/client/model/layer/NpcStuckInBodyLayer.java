...
public abstract class NpcStuckInBodyLayer<T extends Npc, M extends NpcModel<T>> extends RenderLayer<T, M> {
    public NpcStuckInBodyLayer(LivingEntityRenderer<T, M> pRenderer) {
        super(pRenderer);
    }
