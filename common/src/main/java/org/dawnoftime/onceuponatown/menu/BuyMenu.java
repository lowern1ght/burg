...
public class BuyMenu extends NpcBaseMenu {
    ...
    public BuyMenu(int containerId, Inventory playerInventory, InteractingNpc npc) {
    ...
    public List<BuyDeal> getDeals() {
        return this.interactingNpc.getBuyDeals();
    }
    ...
    public static class BuyResultSlot extends Slot {
        ...
        public BuyResultSlot(Player player, InteractingNpc npc, BuyContainer buyContainer, int slot, int posX, int posY) {
